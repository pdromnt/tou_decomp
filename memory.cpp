...
char  DAT_00481c58[80] = {0};  /* Entity config defaults table 1 */
char  DAT_00481ca8[80] = {0};  /* Entity config defaults table 2 */
...
#define ALLOC_POOL(ptr, size) \
    ...
    DAT_00487810 = static_cast<PlayerData *>(Mem_Alloc(player_pool_bytes));
